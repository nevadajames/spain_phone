...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Validates Spanish phone numbers}
  spec.description   = %q{Validates Spanish landlines and mobile numbers. There are also methods to get province for landline numbers and type.}
